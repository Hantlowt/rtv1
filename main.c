...
/*   Updated: 2016/05/04 16:58:37 by alhote           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	w->lights = init_light(vect(0.0, 20.0, -20.0), 2);
	...
	//add_obj(w->objects, init_plane(vect(0.0, 50.0, 0.0), vect(0.0, -1.0, 0.0), hsl(100, 10, 100)));
